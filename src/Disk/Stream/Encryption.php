...
class Encryption extends Stream
{
	...
	public function __construct($stream, $mode = 'r')
	{
		...
		stream_filter_append($this->resource, 'openssl.encrypt', STREAM_FILTER_WRITE, [
			'method' => 'AES-256-CFB',
			'password' => $key,
			'iv' => $iv
		]);

		stream_filter_append($this->resource, 'openssl.decrypt', STREAM_FILTER_READ, [
			'method' => 'AES-256-CFB',
			'password' => $key,
			'iv' => $iv
		]);
