...
use Http\Client\Curl\ResponseParser;
 ...
 * @author  Dmitry Arhitector <lovesosabitch@yandex.ru>
 *
 * @TODO
...
class Client implements HttpClient, HttpAsyncClient
{
	...
	public function __construct(MessageFactory $messageFactory, StreamFactory $streamFactory, array $options = [])
	{
		...
		$this->responseParser = new ResponseParser($messageFactory, $this->streamFactory);
	...
	protected function createCurlOptions(RequestInterface $request)
	{
		...
		{ // Allow custom methods with body transfer (PUT, PROPFIND and other.)
